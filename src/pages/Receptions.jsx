                              ...
                              {o.adminUrl ? (
                                ...
                                >
                                  <span className="reception-num__icon-wrap">
                                    ...
                                    >
                                      <path
                                        d="M15.5 5.5c-.1-.3-.3-.5-.6-.5-.1 0-.6 0-1.3-.1-.7-.7-1.3-1.4-1.6-1.4-.1 0-.1 0-.2 0L3 18.7l8.3 1.6 5.6-1.2-1.4-13.6z"
                                        fill="#95BF47"
                                      />
                                      <path
                                        d="M14.9 5c-.1 0-.5 0-1 .1-.4-1-1-2-2.1-2-.1 0-.2 0-.3 0-.3-.4-.7-.5-1-.5-2.4 0-3.5 3-3.9 4.5-.9.3-1.6.5-1.7.5-.5.2-.5.2-.6.7l-1.6 12.2L15 22.5V5c-.1 0-.1 0-.1 0zm-2.4.4c-.3.1-.7.2-1.2.4 0-.8-.2-1.4-.4-1.9.7.1 1.2.9 1.6 1.5zm-1.8-1.3c.3.6.5 1.3.5 2.3v.1c-.8.2-1.6.5-2.4.7.5-1.6 1.4-2.5 1.9-3.1zm-.8-.7c.1 0 .3 0 .4.1-.7.6-1.6 1.7-2 4-.6.2-1.2.4-1.8.5.4-1.5 1.4-4.6 3.4-4.6z"
                                        fill="#5E8E3E"
                                      />
                                      <path
                                        d="M14.9 5.1c-.1 0-.5 0-1 .1-.4-1-1-2-2.1-2-.1 0-.2 0-.3 0-.3-.4-.7-.5-1-.5-2.4 0-3.5 3-3.9 4.5-.9.3-1.6.5-1.7.5-.5.2-.5.2-.6.7-.1.4-1.3 9.8-1.3 9.8l8.3 1.6 4.5-1V5.1z"
                                        fill="#95BF47"
                                      />
                                      <path
                                        d="M11.6 9.5l-.6 1.6s-.6-.4-1.3-.4c-1.1 0-1.1.7-1.1.8 0 .8 2.1 1.2 2.1 3.1 0 1.5-.9 2.4-2.2 2.4-1.5 0-2.3-.9-2.3-.9l.4-1.3s.8.7 1.5.7c.5 0 .7-.4.7-.6 0-1-1.7-1.1-1.7-2.8 0-1.4 1-2.8 3.2-2.8.8 0 1.3.2 1.3.2z"
                                        fill="#FFFFFF"
                                      />
                                    </svg>
                                  </span>
