...
const MAX_PAGES = 12 // 12 × 250 = 3 000 commandes max
    ...
    for (const o of orders) {
      for (const li of o.lineItems || []) {
        ...
        existing.currency =
          ...
          o.currency ||
          existing.currency
        if (!existing.imageUrl && li.image?.url)
          existing.imageUrl = li.image.url
  ...
  return (
    <div className="page rapports">
      ...
      <nav className="rapports__subpages" aria-label="Sous-pages">
        <button type="button" className="rapports__subpage is-active">
          Meilleures ventes
        </button>
      </nav>
